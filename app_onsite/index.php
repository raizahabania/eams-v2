                    ...
                    <div class="card shadow">
                        <button type="button" id="TimeIn" data-bs-target="#myCarousel" data-bs-slide-to="0" class="p-2 rounded-2 bg-white border border-0 active" aria-current="true" aria-label="Slide 1">
                            <div class="card-body pt-5 p-4">
                                ...
                                <h3 class="fw-bolder tc-blue500">Time In</h3>
                            </div>
                        </button>
                    ...
                    <div class="card shadow">
                        <button type="button" id="BreakOut" data-bs-target="#myCarousel" data-bs-slide-to="1" class="p-2 rounded-2 bg-white border border-0 active" aria-current="true" aria-label="Slide 2">
                            <div class="card-body pt-5 p-4">
                                ...
                                <h3 class="fw-bolder tc-yellow500">Break Out</h3>
                            </div>
                        </button>
                        <div class="card-footer font-monospace p-4 py-3">
                    ...
                    <div class="card shadow">
                        <button type="button" id="BreakIn" data-bs-target="#myCarousel" data-bs-slide-to="2" class="p-2 rounded-2 bg-white border border-0 active" aria-current="true" aria-label="Slide 3">
                            <div class="card-body pt-5 p-4">
                                ...
                                <h3 class="fw-bolder tc-emerald600">Break In</h3>
                            </div>
                        </button>
                        <div class="card-footer font-monospace p-4 py-3">
                ...
                <div class="col">
                    <div class="card shadow">
                        <button type="button" id="TimeOut" data-bs-target="#myCarousel" data-bs-slide-to="3" class="p-2 rounded-2 bg-white border border-0 active" aria-current="true" aria-label="Slide 4">
                            <div class="card-body pt-5 p-4">
                                <div class="bs-icon-lg bs-icon-rounded bgc-rose700 d-flex flex-shrink-0 justify-content-center align-items-center position-absolute mb-3 bs-icon lg" style="top: -30px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="#fff" viewBox="0 0 16 16" class="bi bi-clock">
                                        <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"></path>
                                        <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z"></path>
                                    </svg>
                                </div>
                                <h3 class="fw-bolder tc-rose700">Time Out</h3>
                            </div>
                        </button>
                        <div class="card-footer font-monospace p-4 py-3">
...
<script>
    ...
    var dateNow = date_now_server.format('ddd | MMMM DD, YYYY');
    ...
    $('#settingModal').on('hidden.bs.modal', function() {
        if (global_action == "timein") {
            time_in.focus();
        } else if (global_action == "breakout") {
            break_out.focus();
        } else if (global_action == "breakin") {
            break_in.focus();
        } else if (global_action == "timeout") {
            time_out.focus();
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.status == 'success') {
                    msg_html('<img src="<?php echo BASE_URL; ?>assets/img/' + data.image + '" width="200" style="border-radius:50%;">', data.name, data.position, data.remark);
                    form[0].reset();
    ...
    $msg_login = $session_class->getValue('msg_login');
    if (isset($msg_login) && $msg_login != "") {
        $msg_login = $session_class->getValue('msg_login');
        echo 'msg_login("' . $msg_login . '");';
        $session_class->dropValue('msg_login');
    }
    ?>
</script>
