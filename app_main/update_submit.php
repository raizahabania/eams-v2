 <?php
    ...
    if ($time_in != "" && $time_out != "") {
        ...
        if ($action == 'save') {
            ...
            $sql = "INSERT  INTO time_log (employee_id,date_log,time_in,time_out,break_in,break_out,manual) VALUES ('" . $employee_id . "', '" . $date_log . "','" . $new_time_in . "','" . $new_time_out . "','" . $new_break_in . "','" . $new_break_out . "','1')";
