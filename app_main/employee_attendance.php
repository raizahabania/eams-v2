...
<script>
    ...
    (function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.message == "success") {
                        $('.dropify-clear').click();
                        success_notif('Record has been Added!');
                        // Toast.fire({
        ...
        $("#form_submit").on('submit', function(e) {
            ...
            if ($("#employee_id").val() == "") {
                $(".form-message").html("Employee Name field cannot be empty");
                $(".form-message").css("display", "block");
                return;
            }

            if ($("#date_log").val() == "") {
                $(".form-message").html("Date field cannot be empty");
                $(".form-message").css("display", "block");
                return;
            }

            if ($("#in").val() == "" && $("#out").val() == "") {
                $(".form-message").html("Time in and Time out cannot be empty");
                $(".form-message").css("display", "block");
            }
